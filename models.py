...
class Venue(db.Model):
    ...
    shows = db.relationship('Shows', backref='show', lazy='dynamic', cascade="all, delete")
...
class Artist(db.Model):
    ...
    genres = db.relationship('Genres', secondary=artist_genres,
      backref=db.backref('artists', lazy=True), cascade="all, delete")
    shows = db.relationship('Shows', secondary=show_artists, backref=db.backref('artist_show', lazy='dynamic'), cascade="all, delete")
...
class Shows(db.Model):
   ...
   # artists = db.relationship('Artist', secondary=show_artists, backref=db.backref('s_artists', lazy=True), cascade="all, delete")
